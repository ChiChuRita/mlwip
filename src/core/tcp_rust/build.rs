...
fn main() {
    ...
    let bindings = bindgen::Builder::default()
        ...
        .allowlist_function("tcp_alloc")
        .allowlist_function("tcp_free")
        .allowlist_function("tcp_enqueue_flags")
        .allowlist_function("tcp_output")
        .allowlist_function("tcp_send_empty_ack")
        .allowlist_function("tcp_next_iss")
        ...
        .allowlist_var("TCP_PRIO_.*")
        .allowlist_var("TCP_WND")
        .allowlist_var("TCP_SND_BUF")
        .allowlist_var("TCP_MSS")
        .allowlist_var("TCP_.*")
        .allowlist_var("ERR_.*")
        .allowlist_var("MEMP_TCP_PCB")
        .allowlist_var("MEMP_TCP_PCB_LISTEN")
